...
Tags: admin, colors, theme, scheme, admin colors, admin scheme
Tested up to: 4.4
...
3. Color Schemes are selected on a per-user basis. Select a scheme by going to Your Profile and selecting a swatch of colors.
